...
class EventType < ApplicationRecord
  ...
  enum name: {
    ...
    to_user_message: 15,  # Сообщение пользователю
    to_user_accept: 16,   # Вопрос пользователю с возможностью указать ответ из двух вариантов (условно "Согласен"/"Не согласен")
    from_user_accept: 17  # Ответ на вопрос пользователю
  }
end
