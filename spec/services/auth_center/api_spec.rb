  ...
  RSpec.describe Api do
    ...
    describe '::client_token' do
      ...
      it 'sends :post request with required params in body' do
        subject.client_token(auth_code)
      ...
      it 'returns instance of Faraday::Response class' do
        expect(subject.client_token(auth_code)).to be_instance_of(Faraday::Response)
      end
    end
    ...
    describe '::app_token' do
      ...
      it 'returns instance of Faraday::Response class' do
        expect(subject.app_token).to be_instance_of(Faraday::Response)
      end
    end
